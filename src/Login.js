  ...
  return (
    <div className="login-container">
      <div className="login-card">
        ...
        <h1 className="login-title">Lali's Spotify Dash</h1>
        <p className="login-subtitle">Connect your Spotify account to view your personalized music analytics</p>
        ...
        <p className="login-disclaimer">
          This app only reads your listening data and never modifies your account
        </p>
      </div>
    </div>
  );
